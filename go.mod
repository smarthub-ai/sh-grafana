...
require (
	buf.build/gen/go/parca-dev/parca/bufbuild/connect-go v1.10.0-20230804045758-4037eccc14f5.1 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.31.0-20230804045758-4037eccc14f5.1 // @grafana/observability-traces-and-profiling
