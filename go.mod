...
require (
	...
	go.opentelemetry.io/otel/log v0.19.0 // @grafana/grafana-operator-experience-squad
	go.opentelemetry.io/otel/sdk v1.43.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/otel/sdk/log v0.19.0 // @grafana/grafana-operator-experience-squad
