...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.72.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.299.1 // @grafana/data-sources-plugins
