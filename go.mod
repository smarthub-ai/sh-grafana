...
require (
	...
	cloud.google.com/go/kms v1.18.0 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240708111419-1398f905affc // @grafana/grafana-app-platform-squad
