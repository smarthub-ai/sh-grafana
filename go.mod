...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.16.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/otel/log v0.16.0 // @grafana/grafana-operator-experience-squad
	go.opentelemetry.io/otel/sdk v1.40.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/otel/sdk/log v0.16.0 // @grafana/grafana-operator-experience-squad
