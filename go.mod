...
require (
	...
	github.com/googleapis/gax-go/v2 v2.12.5 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20240729214237-efda5a3ef28e // @grafana/grafana-app-platform-squad
	...
	google.golang.org/api v0.189.0 // @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20240722135656-d784300faade // indirect; @grafana/grafana-backend-group
