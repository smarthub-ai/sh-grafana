...
require (
	buf.build/gen/go/parca-dev/parca/bufbuild/connect-go v1.10.0-20240704144942-962b089b15fc.1 // @grafana/observability-traces-and-profiling
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240708143745-f763f2085bfb // @grafana/grafana-app-platform-squad
