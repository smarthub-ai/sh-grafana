...
require (
	buf.build/gen/go/parca-dev/parca/bufbuild/connect-go v1.10.0-20240709131200-45114c6d2c4d.1 // @grafana/observability-traces-and-profiling
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240715143831-8f4b76a3ded8 // @grafana/grafana-app-platform-squad
