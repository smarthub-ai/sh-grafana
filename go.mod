...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.221.0 // @grafana/plugins-platform-backend
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.5.2 // @grafana/backend-platform
