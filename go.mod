...
require (
	...
	cloud.google.com/go/kms v1.15.8 // @grafana/grafana-backend-group
	cloud.google.com/go/storage v1.40.0 // @grafana/grafana-backend-group
	...
	github.com/googleapis/gax-go/v2 v2.12.4 // @grafana/grafana-backend-group
	...
	google.golang.org/api v0.181.0 // @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20240401170217-c3f982113cda // indirect; @grafana/grafana-backend-group
