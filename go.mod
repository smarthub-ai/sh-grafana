...
require (
	...
	github.com/blevesearch/bleve/v2 v2.5.1 // @grafana/grafana-search-and-storage
	github.com/blevesearch/bleve_index_api v1.2.8 // @grafana/grafana-search-and-storage
